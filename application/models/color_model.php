...
class Color_model extends Model {
	...
	function Color_model(){
		...
		$this->aContainer=array(
			...
			's_type'		=> array('caption'=>'Type','rules'=>'trim','view'=>1,'edit'=>1),
			's_notes'		=> array('caption'=>'Notes','rules'=>'','view'=>1,'edit'=>1),
			'n_price'		=> array('caption'=>'Price','rules'=>'trim|numeric','view'=>1,'edit'=>1),
			'n_price_a'		=> array('caption'=>'Price A','rules'=>'trim|numeric','view'=>1,'edit'=>1),
			'n_price_e'		=> array('caption'=>'Price E','rules'=>'trim|numeric','view'=>1,'edit'=>1),
			'n_price_pt'	=> array('caption'=>'Price PT','rules'=>'trim|numeric','view'=>1,'edit'=>1),
			'n_price_pte'	=> array('caption'=>'Price PTE','rules'=>'trim|numeric','view'=>1,'edit'=>1)
		);
	}
	...
	function delete($sCode){
		$this->db->where('s_code', $sCode);
		return $this->db->delete('tm_color');
	}
}
?>
