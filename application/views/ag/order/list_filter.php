...
<form id="frmSearch" name="frmSearch" method="post" onKeyPress="_onPressEnter(this, event)">
	...
	<div class="textboxlist separator textboxlistCostume">
		<table class="custom-table">
			...
			<tr>
				<td>Brand</td>
				<td><input type="text" id="s_brand_filter" name="s_brand_filter" value="<?= $s_brand_filter ?>" size="18"></td>
			</tr>
			<tr>
				<td>Location</td>
				<td><select id="s_location_filter" name="s_location_filter" style="width:119px;">
	...
	<div class="textboxlist separator textboxlistCostume">
		<table class="custom-table">
			...
			<tr>
				...
				<td> <input type="text" id="n_production_date_year_filter" name="n_production_date_year_filter" size="2" value="<?= $n_production_date_year_filter ?>"></td>
			</tr>
		</table>
