<form id="frmSearch" name="frmSearch" method="post" onKeyPress="_onPressEnter(this, event)">
	...
	<div class="textboxlist">
		<ul>
			...
			<li>Item Code<input type="text" id="s_smodel_filter" name="s_smodel_filter" value="<?=$s_smodel_filter?>" size="12"></li>
		</ul>
	</div>
	...
	<div class="textboxlist separator">
		<ul>
			...
			<li>Buyer
				<select name="s_buyer_filter" id="s_buyer_filter" style="width:119px;">
	...
	<div class="textboxlist separator">
		<ul>
			<li>Order
				...
				<input type="text" id="d_order_date_year_filter" name="d_order_date_year_filter" size="2" value="<?=$d_order_date_year_filter?>">
			</li>
			<li>Prod.
				...
				<input type="text" id="d_production_date_year_filter" name="d_production_date_year_filter" size="2" value="<?=$d_production_date_year_filter?>">
			</li>
		</ul>
	</div>
