<form id="frmSearch" name="frmSearch" method="post" onKeyPress="_onPressEnter(this, event)">
	...
	<div class="textboxlist separator">
		<ul>
			...
			<li>Lot
				<input type="text" id="s_lot_no_filter" name="s_lot_no_filter" value="<?=$s_lot_no_filter?>" size="10">
			</li>
			<li>Model
	...
	<div class="textboxlist separator">
		<ul>
			<li>Buyer
				<select name="s_buyer_filter" id="s_buyer_filter" style="width:122px;">
	...
	<div class="button separator">
		<a href="javascript:_doPost(null, null, null, 'frmSearch', '<?=$siteurl?>')" rel="btnFilterReportSerialDate" title="Search/Filter Serial Date Report"><img src="<?=$baseurl?>images/ribbon/find32.png"/>Search</a>
	</div>
	<div class="button">
		<a href="javascript:_doPost(null, null, null, 'frmSearch', '<?=$siteurl?>1')" rel="btnExcelReportSerialDate" title="Export Serial Date Report to Excel"><img src="<?=$baseurl?>images/ribbon/excel32.png"/>Excel</a>
	</div>
</form>
