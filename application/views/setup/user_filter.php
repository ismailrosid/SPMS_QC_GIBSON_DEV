<form id="frmSearch" name="frmSearch" method="post" onKeyPress="_onPressEnter(this, event)">
	...
	<div class="textboxlist">
		<ul>
			<li>User Name<input type="text" id="s_username_filter" name="s_username_filter" value="<?=$s_username_filter?>"></li>
			<li>Level<input type="text" id="s_level_filter" name="s_level_filter" value="<?=$s_level_filter?>"></li>
		</ul>
	</div>
	<div class="textboxlist separator">
		<ul>
			<li>Name<input type="text" id="s_name_filter" name="s_name_filter" value="<?=$s_name_filter?>"></li>
			<li>NIP<input type="text" id="s_nip_filter" name="s_nip_filter" value="<?=$s_nip_filter?>"></li>
		</ul>
	</div>
