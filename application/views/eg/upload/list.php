<form id="frmEdit" name="frmEdit" method="post" action="{siteurl}uploaded/{sDivision}/{sFileName}" onKeyPress="_onPressEnter(this, event)">
	...
	<table class="table" style="width:580px;" align="left">
		<thead>
			<tr class="table_header">
				...
				<th><a href="#" onClick="_doPost('sSort', 's_serial_no_2', 'bSortAction')">Serial No Body</a></th>
		...
		{sData}
			<tr><td width="10px"><input type="checkbox" name="uIdRow[]" value="{n_number}"></td>
				...
				<td><input type="text" id="s_serial_no_2:{n_number}" name="s_serial_no_2:{n_number}" value="{s_serial_no_2}" size="21" maxlength="21"></td>
