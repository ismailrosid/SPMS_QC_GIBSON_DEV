<form id="frmSearch" name="frmSearch" method="post" onKeyPress="_onPressEnter(this, event)">
	...
	<div class="textboxlist">
		<ul>
			...
			<li>
				<input type="text" id="d_transaction_date_filter" name="d_transaction_date_filter" size="7" value="<?=$d_transaction_date_filter?>">
				...
				<select id="n_line_filter" name="n_line_filter" style="width:53px;">
					<?=$n_line_filter?>
				</select>
			</li>
		</ul>
