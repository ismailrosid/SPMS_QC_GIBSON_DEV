	...
	<table class="table" style="width:1700px;">
		<thead class="table_header_2">
			<tr><th rowspan="2"><a href="#" onClick="_doPost('sSort', 'd_production_date', 'bSortAction')">Month</a></th>
				...
				<th width="45px" rowspan="2"><a href="#" onClick="_doPost('sSort', 'd_process_2', 'bSortAction')">WK-I Center Output</a></th>
...
<?php 		foreach($tt_report_stock as $nIndex=>$aValue){?>
			<tr><td><?=$aValue['d_production_date']?></td>
				...
				<td align="right"><?=$aValue['d_process_1s']?></td>
				<td align="right"><?=($aValue['d_process_1'] == '1900-01-01' ? '####-##-##' : $aValue['d_process_1'])?></td>
				<td align="right"><?=$aValue['d_process_1_2b']?></td>
