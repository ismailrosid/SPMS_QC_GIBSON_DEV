...
<?php 							} ?>
			...
			<td valign="top" align="left">
				...
				<tbody>
					<tr><td>b22010 (WK-I Center Input)</td>
					...
					<tr><td>Body Serial No</td>
						<td colspan="2"><input type="text" id="s_serial_no_2" name="s_serial_no_2" value="{s_serial_no_2}" maxlength="21"></td>
					</tr>
					<tr><td>b22030 (WK-I Center Output)</td>
					...
					<tr><td>b22050 (WK-II Control Center)</td>
					...
					<tr><td>b22090 (Assembly-I_Control Center)</td>
					...
					<tr><td>b22130 (Warehouse Outgoing)</td>
...
<script type="text/javascript">
	...
	function setProcessValidation() {
		...
		if ( 	$('#d_process_2').val().replace(' ', '')!='' && $('#s_serial_no_2').val().replace(' ', '')=='' &&
				$('#bValidation').attr('checked')==true ) {
			bValid=false;
		}
		if (bValid==false) {
			alert('Process Data is Failed');
		}
		return bValid;
	}
</script>
