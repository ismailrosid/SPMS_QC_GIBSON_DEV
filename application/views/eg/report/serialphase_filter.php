<form id="frmSearch" name="frmSearch" method="post" onKeyPress="_onPressEnter(this, event)">
	...
	<div class="textboxlist">
		<ul>
			...
			<li>Phase
				<select name="s_phase_filter" id="s_phase_filter" style="width:69px;">
					<?=$s_phase_filter?>
				</select>
				<select id="s_type_filter" name="s_type_filter" style="width:55px;">
	...
	<div class="textboxlist separator">
		<ul>
			...
			<li>Line
				<select id="n_line_filter" name="n_line_filter" style="width:78px;">
					<?=$n_line_filter?>
				</select>
			</li>
		</ul>
	...
	<div class="textboxlist separator">
		<ul>
			<li>Location
				<select name="s_location_filter" id="s_location_filter" style="width:130px;">
	...
	<div class="button separator">
		<a href="javascript:_doPost(null, null, null, 'frmSearch', '<?=$siteurl?>')" rel="btnFilterReportSerialPhase" title="Search/Filter Serial Phase Report"><img src="<?=$baseurl?>images/ribbon/find32.png"/>Search</a>
	</div>
	<div class="button">
		<a href="javascript:_doPost(null, null, null, 'frmSearch', '<?=$siteurl?>1')" rel="btnExcelReportSerialPhase" title="Export Serial Phase Report to Excel"><img src="<?=$baseurl?>images/ribbon/excel32.png"/>Excel</a>
	</div>
</form>
