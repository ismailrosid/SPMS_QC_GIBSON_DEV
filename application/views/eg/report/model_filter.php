<form id="frmSearch" name="frmSearch" method="post" onKeyPress="_onPressEnter(this, event)">
	...
	<div class="button">
		<a href="javascript:_doPost(null, null, null, 'frmSearch', '<?=$basesiteurl?>/eg/reportlist/groupexcel/<?=$sViewReport?>')" rel="btnExcelReportModel" title="Export Model Report to Excel"><img src="<?=$baseurl?>images/ribbon/excel32.png"/>Excel</a>
	</div>
</form>
