<table class="table" style="width:1660px;">
	<thead class="table_header_2">
		<tr>
			<th rowspan="2"><a href="#" onClick="_doPost('sSort', 'd_production_date', 'bSortAction')">Month</a></th>
			...
			<th rowspan="2"><a href="#" onClick="_doPost('sSort', 's_smodel', 'bSortAction')">Cancel Qty</a></th>
		...
		<tr>
			<th width="45px" align="center"><a href="#" onClick="_doPost('sSort', 'n_process_1s', 'bSortAction')">-</a></th>
