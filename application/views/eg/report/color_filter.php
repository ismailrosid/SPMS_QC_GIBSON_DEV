<form id="frmSearch" name="frmSearch" method="post" onKeyPress="_onPressEnter(this, event)">
	...
	<div class="textboxlist textboxlistCostume">
		<table class="custom-table">
			...
			<tr>
				<td>Buyer</td>
				<td><select name="s_buyer_filter" id="s_buyer_filter" style="width:130px;">
	...
	<div class="textboxlist separator textboxlistCostume">
		<table>
			...
			<tr>
				<td>Location</td>
				<td colspan="2">
					<select name="s_location_filter" id="s_location_filter" style="width:119px;">
	...
	<div class="button">
		<a href="javascript:_doPost(null, null, null, 'frmSearch', '<?= $basesiteurl ?>/eg/reportlist/groupexcel/<?= $sViewReport ?>')" rel="btnExcelReportColor" title="Export Color Report to Excel"><img src="<?= $baseurl ?>images/ribbon/excel32.png" />Excel</a>
	</div>
</form>