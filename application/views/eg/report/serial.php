	...
	<table class="table" style="width:1700px;">
		<thead class="table_header_2">
			...
			<tr><th width="45px" align="center"><a href="#" onClick="_doPost('sSort', 'n_process_1s', 'bSortAction')">-</a></th>
				...
				<th width="45px" align="center"><a href="#" onClick="_doPost('sSort', 'n_process_1_2b', 'bSortAction')">Body</a></th>
				...
				<th width="45px" align="center"><a href="#" onClick="_doPost('sSort', 'n_process_2_2b', 'bSortAction')">Body</a></th>
			</tr>
		</thead>
		<tbody>
			{tt_report_stock}
			<tr><td>{d_production_date}</td>
				...
				<td align="right">{n_process_1_2b}</td>
				<td align="right">{n_process_2s}</td>
				<td align="right">{n_process_2}</td>
				<td align="right">{n_process_2_2b}</td>
