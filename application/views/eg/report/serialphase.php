<form method="post" id="frmSearch" name="frmSearch" onKeyPress="_onPressEnter(this, event)">
	<table class="table" style="width:1550px;">
		<thead class="table_header">
			<tr><th><a href="#" onClick="_doPost('sSort', 'd_production_date', 'bSortAction')">Month</a></th>
				...
				<th><a href="#" onClick="_doPost('sSort', 'd_process_1', 'bSortAction')">WK-I Center Input</a></th>
				<th><a href="#" onClick="_doPost('sSort', 'd_process_2', 'bSortAction')">WK-I Center Output</a></th>
				<th><a href="#" onClick="_doPost('sSort', 'd_process_3', 'bSortAction')">WK-II</a></th>
				<th><a href="#" onClick="_doPost('sSort', 'd_process_4', 'bSortAction')">WK-II Control Center</a></th>
				<th><a href="#" onClick="_doPost('sSort', 'd_process_5', 'bSortAction')">Coating-I</a></th>
				<th><a href="#" onClick="_doPost('sSort', 'd_process_6', 'bSortAction')">Coating-IIA</a></th>
				<th><a href="#" onClick="_doPost('sSort', 'd_process_7', 'bSortAction')">Coating-IIB</a></th>
				<th><a href="#" onClick="_doPost('sSort', 'd_process_8', 'bSortAction')">Assembly-I_Control Center</a></th>
				<th><a href="#" onClick="_doPost('sSort', 'd_process_9', 'bSortAction')">Assembly-II</a></th>
				<th><a href="#" onClick="_doPost('sSort', 'd_process_10', 'bSortAction')">Packing</a></th>
				<th><a href="#" onClick="_doPost('sSort', 'd_warehouse', 'bSortAction')">Warehouse Incoming</a></th>
				<th><a href="#" onClick="_doPost('sSort', 'd_process_14', 'bSortAction')">Warehouse Outgoing</a></th>
