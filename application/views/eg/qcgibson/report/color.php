<table class="table" style="width:1600px;">
	<thead>
		<tr class="table_header">
			...
			<th width="70px"><a href="#" onClick="_doPost('sSort', 'n_gibson_checking', 'bSortAction')">Gibson Checking</a></th>
			<th width="70px"><a href="#" onClick="_doPost('sSort', 'n_t_process_10', 'bSortAction')">Packing</a></th>
	...
	<tbody>
		...
		<tr>
			...
			<td align="right">{n_process_gibson}</td>
	...
	<tfoot class="table_footer">
		...
		<tr>
			...
			<td align="right">{n_t_process_gibson}</td>
