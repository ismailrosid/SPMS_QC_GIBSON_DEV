...
if ($this->session->userdata('b_master_write')) { ?>
	...
	<div class="button">
		<a href="javascript:_doPost(null, null, null, 'frmEdit', '<?= $siteurl ?>editStatus/1', true, 'Are you sure you want to Active the selected item ?')" rel="btnActiveModel" title="Active Model"><img src="<?= $baseurl ?>images/ribbon/edit32.png" />Active</a>
	</div>
	<div class="button">
		<a href="javascript:_doPost(null, null, null, 'frmEdit', '<?= $siteurl ?>editStatus/0', true, 'Are you sure you want to Non Active the selected item ?')" rel="btnNonActiveModel" title="Non Active Model"><img src="<?= $baseurl ?>images/ribbon/edit32.png" />Non Active</a>
	</div>
	<div class="button">
		<a href="javascript:_doPost(null, null, null, 'frmEdit', '<?= $siteurl ?>delete', true, 'Are you sure you want to delete the selected item ?')" rel="btnDeleteModel" title="Remove Model"><img src="<?= $baseurl ?>images/ribbon/delete32.png" />Delete</a>
	</div>
