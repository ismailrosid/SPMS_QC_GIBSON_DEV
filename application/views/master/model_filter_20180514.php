<form id="frmSearch" name="frmSearch" method="post" onKeyPress="_onPressEnter(this, event)">
	...
	<div class="textboxlist">
		<ul>
			<li>Model Code<input type="text" id="s_code_filter" name="s_code_filter" value="<?=$s_code_filter?>" size="13"></li>
			<li>Description<input type="text" id="s_description_filter" name="s_description_filter" value="<?=$s_description_filter?>" size="13"></li>
			<li>Division
	...
	<div class="textboxlist separator">
		<ul>
			<li>Type<input type="text" id="s_type_filter" name="s_type_filter" value="<?=$s_type_filter?>" size="10"></li>
			<li>UPC<input type="text" id="s_upc_code_filter" name="s_upc_code_filter" value="<?=$s_upc_code_filter?>" size="10"></li>
		</ul>
	</div>
