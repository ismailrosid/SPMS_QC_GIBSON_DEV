...
class Reportcontrol extends Controller {
	...
	function Reportcontrol(){
		...
		$this->load->model('eg/Reportcontrol_model');
	...
	function index($sMessage=''){
		...
		$aDisplay=array('baseurl'			=> base_url(),
						...
						'siteurl'			=> site_url().'/eg/reportcontrol/',
						'MESSAGES'			=> '',
	...
	function color($sMessage=''){
		...
		if (empty($sMessage)) {
			...
			$aDisplay=array('baseurl'			=> base_url(),
							'basesiteurl'		=> site_url(),
							'siteurl'			=> site_url().'/eg/reportcontrol/color/',
							
							'MESSAGES'			=> '',
							'PAGE_TITLE'		=> 'SPMS-G. Electric Guitar/Time Lead Control by Color',
			...
			$aDisplay['viewFilter'] = $this->load->view('eg/reportcontrol/color_filter', $aDisplay, TRUE);
			
			$this->parser->parse('header', $aDisplay);
			$this->parser->parse('eg/reportcontrol/color', $aDisplay);
			$this->parser->parse('footer', $aDisplay);
		} else {
			...
			$aHeader = array(
				...
				'n_line' => 'Line',
				'n_qty' => 'Qty',
				'd_process_1_plan' => 'Plan WK-I Center Input',
				'd_process_1' => 'Actual WK-I Center Input',
				's_process_1_location' => 'Location WK-I Center Input',
				'd_process_2_plan' => 'Plan WK-I Center Output',
				'd_process_2' => 'Actual WK-I Center Output',
				's_process_2_location' => 'Location WK-I Center Output',
				'd_process_3_plan' => 'Plan WK-II',
				'd_process_3' => 'Actual WK-II',
				's_process_3_location' => 'Location WK-II',
				'd_process_4_plan' => 'Plan WK-II Control Center',
				'd_process_4' => 'Actual WK-II Control Center',
				's_process_4_location' => 'Location WK-II Control Center',
				'd_process_5_plan' => 'Plan Coating-I',
				'd_process_5' => 'Actual Coating-I',
				's_process_5_location' => 'Location Coating-I',
