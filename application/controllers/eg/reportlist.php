	...
	function serialdate($sMessage = '')
	{
		...
		if (empty($sMessage)) {
			...
			$aHeader = array(
				...
				's_process_1_by' => 'WK-I Center Input Person',
				'd_process_2s' => 'WK-I Center Output',
				'd_process_2' => 'WK-I Center Output [Bolt-Neck]',
				'd_process_2_2b' => 'WK-I Center Output [Bolt-Body]',
				's_process_2_by' => 'WK-I Center Output Person',
				'd_process_3' => 'WK-II',
				's_process_3_by' => 'WK-II Person',
				'd_process_4' => 'WK-II Control Center',
				's_process_4_by' => 'WK-II CC Person',
				'd_process_5' => 'Coating-I',
				's_process_5_by' => 'CI Person',
				'd_process_6' => 'Coating-IIA',
				's_process_6_by' => 'CIIA Person',
				'd_process_7' => 'Coating-IIB',
				's_process_7_by' => 'CIIB Person',
				'd_process_8' => 'Assembly-I_Control Center',
				's_process_8_by' => 'AICC Person',
				'd_process_9' => 'Assembly-II',
				's_process_9_by' => 'AII Person',
				'd_process_10' => 'Packing',
				's_process_10_by' => 'Pack Person',
				'd_warehouse' => 'Warehouse Incoming',
				's_process_warehouse_by' => 'WH-IN Person',
				'd_process_14' => 'Warehouse Outgoing',
				's_process_14_by' => 'WH-OUT Person',
			);
			$aDatas = array();
			foreach ($aAllDataProduct as $nRow => $aEachDataProduct) {
				$aData = array();
...
function rekapOrderPackingExp($sMessage = '')
	{
		...
		if (empty($sMessage)) {
			...
			$aDisplay = array(
				'baseurl'			=> base_url(),
				'basesiteurl'		=> site_url(),
				'siteurl'			=> site_url() . '/eg/reportlist/rekaporderpackingexp/',

				'MESSAGES'			=> '',
				'PAGE_TITLE'		=> 'SPMS-G. Electric Guitar Rekap Order',
				'filterCaption'		=> 'EG Report Filter/Search',
			...
			$aDisplay['viewFilter'] = $this->load->view('eg/report/rekapope_filter', $aDisplay, TRUE);

			$this->parser->parse('header', $aDisplay);
			$this->parser->parse('eg/report/rekapope', $aDisplay);
			$this->parser->parse('footer', $aDisplay);
		} else {
			...
			$aDatas[] = $aTotalDatas;
			$name = 'Rekap_order_EG_' . $allYear[0] . '-' . end($allYear);
